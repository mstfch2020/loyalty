...
const userState: UserState = {
  user: {
    Name: '', Token: '', Id: 0, PhoneNumber: '', FirstName: '', InsertDate: new Date(), LastName: '', UserName: '', UserTypeId: 0
  },
};
...
export class AuthService extends StoreService<UserState> {
  ...
  * @param password
  */
  public register(name: string, family: string, nationalityCode: string,
    personType: number, unit: number, phoneNumber: string, username: string,
    password: string): Observable<BaseResponse<User>>
  {
